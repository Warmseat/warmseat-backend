...
- Clone the repository
   ...
   ```bash
    git clone https://github.com/Warmseat/warmseat-frontend.git
    git clone https://github.com/Warmseat/warmseat-backend.git
    cd warmseat-frontend
    cd warmseat-backend
...
1. What are the key strengths of each person on the team?
    ...
    - Paul:
        - Cooperation and planning. Leadership and flexibility.
    - Sydney:
